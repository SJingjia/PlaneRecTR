...
def register_single_nyuv2_plane_annos_seg(name,  metadata, plane_seg_json):
    ...
    MetadataCatalog.get(plane_seg_name).set(
        ...
        evaluator_type = "nyuv2_plane_seg",
        ignore_label = 20, 
        # **metadata,
    )


def register_all_single_nyuv2_plane_annos_seg(json_root):
...
_root = os.path.join(os.getenv("DETECTRON2_DATASETS", "datasets"), 'nyuv2_plane') # 26
...
if __name__ == "__main__":
    plot_samples("single_nyuv2_plane_seg_test", n = 3)
